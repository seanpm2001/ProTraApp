# Start of script
_WindowsMIMEidentifier_ = str("Windows 10 build 1709: Python 3")
# Connecting 2 Windows 10 build 1709 programs together. Due to technical limitations with my knowledge on Python, this is currently just a demo script and is not yet functional
# Definitions
...
# End of main method
""" File info
File version: `1 (Tuesday, March 9th 2021 at 9:18 pm)
