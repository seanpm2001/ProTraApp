#include <stdio.h>
// Start of script
// Connecting 2 FreeBSD 1 apps together (32 bit)
// Definitions
union freeBSD_1(int(1)) // Trying to form a class here, so it can detect from different Fedora versions.
...
/* File info
* File version: `1 (Thursday, March 11th 2021 at 9:58 pm)
