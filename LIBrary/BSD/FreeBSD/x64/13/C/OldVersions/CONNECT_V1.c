#include <stdio.h>
// Start of script
// Connecting 2 FreeBSD 13 apps together (64 bit) # It took me from v5 up until v9 to fix the typo of 32 bit => 64 bit
// Definitions
union freeBSD_13(int(13)) // Trying to form a class here, so it can detect from different Fedora versions.
...
/* File info
* File version: `1 (Thursday, March 11th 2021 at 10:15 pm)
