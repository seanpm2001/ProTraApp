// Start of script
public class macOS_10_11(10.11) {
    // I am assuming OS X 10.8 is the first version of MacOS to support Swift.
    // Connecting 2 OS X 10.11 programs together. Note that I have very little experience with Swift, so this script likely doesn't work correctly, and is currently just a demo script
    //Definitions
    NSString *str = @"",";
...
/* File info
* File version: `1 (Monday, March 8th 2021 at 8:26 pm)
