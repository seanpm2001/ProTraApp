# Start of script
_AppleMIMEidentifier_ = str("OS X 10.11 Python 3")
# Connecting 2 OS X 10.11 programs together. Due to technical limitations with my knowledge on Python, this is currently just a demo script and is not yet functional
# Definitions
...
# End of main method
""" File info
File version: `1 (Monday, March 8th 2021 at 8:52 pm)
