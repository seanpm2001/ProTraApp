...
param2_callName:(param2_type)param2_varName;
  @MacOS_10_11_ObjectiveC classname : superclassname {
    // Start of script
    // Connecting 2 OS X 10.11 programs together. Note that I have very little experience with Objective-C, so this script likely doesn't work correctly, and is currently just a demo script
    //Definitions
...
@end
/* File info
* File version: `1 (Monday, March 8th 2021 at 8:03 pm)
