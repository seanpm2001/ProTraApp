# Start of script
_AppleMIMEidentifier_ = str "Mac OS X 10.2 Python 2"
# Connecting 2 Mac OS X 10.2 programs together. Due to technical limitations with my knowledge on Python, this is currently just a demo script and is not yet functional
# Definitions
...
# End of main method
""" File info
File version: `1 (Monday, March 8th 2021 at 9:10 pm)
