-- Start of script
-- Connecting 2 MacOS 11.1 programs together. Note that I have very little experience with AppleScript, so this script likely doesn't work correctly, and is currently just a demo script
-- Definitions
class macos11_1 -- Trying to form a class here, so it can detect from different MacOS 11.1 App versions.
...
-- End of main method
-- File info
-- File version: `1 (Monday, March 8th 2021 at 7:28 pm)
