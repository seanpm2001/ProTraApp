-- Start of script
-- Connecting 2 Mac OS X 10.3 together. Note that I have very little experience with AppleScript, so this script likely doesn't work correctly, and is currently just a demo script
-- Definitions
class macos10_3 -- Trying to form a class here, so it can detect from different Mac OS X 10.3 App versions.
...
-- End of main method
-- File info
-- File version: `1 (Monday, March 8th 2021 at 7:05 pm)
