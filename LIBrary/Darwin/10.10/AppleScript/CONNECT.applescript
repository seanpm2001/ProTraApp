-- Start of script
-- Connecting 2 OS X 10.10 programs together. Note that I have very little experience with AppleScript, so this script likely doesn't work correctly, and is currently just a demo script
-- Definitions
class macos10_10 -- Trying to form a class here, so it can detect from different OS X 10.10 App versions.
...
-- End of main method
-- File info
-- File version: `1 (Monday, March 8th 2021 at 7:15 pm)
