...
param2_callName:(param2_type)param2_varName;
  @MacOS_10_6_ObjectiveC classname : superclassname {
    // Start of script
    // Connecting 2 Mac OS X 10.6 programs together. Note that I have very little experience with Objective-C, so this script likely doesn't work correctly, and is currently just a demo script
    //Definitions
...
@end
/* File info
* File version: `1 (Monday, March 8th 2021 at 7:55 pm)
