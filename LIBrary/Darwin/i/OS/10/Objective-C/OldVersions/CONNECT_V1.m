...
param2_callName:(param2_type)param2_varName;
  @MiOS10_ObjectiveC classname : superclassname {
    // Start of script
    ...
    // Connecting iOS 10 applications together. Note that I have very little experience with Objective-C, so this script likely doesn't work correctly, and is currently just a demo script
    //Definitions
