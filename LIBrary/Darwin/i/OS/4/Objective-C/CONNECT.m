...
param2_callName:(param2_type)param2_varName;
  @MiOS4_ObjectiveC classname : superclassname {
    // Start of script
    ...
    // Connecting iOS 4 applications together. Note that I have very little experience with Objective-C, so this script likely doesn't work correctly, and is currently just a demo script
    //Definitions
...
@end
/* File info
* File version: `1 (Thursday, March 11th 2021 at 8:27 pm)
