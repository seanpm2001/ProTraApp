...
-- Connecting 2 iOS 5 applications together. Note that I have very little experience with AppleScript, so this script likely doesn't work correctly, and is currently just a demo script
-- Definitions
class iOS_5 -- Trying to form a class here, so it can detect from different iPhone OS 1 App versions.
...
-- End of main method
-- File info
-- File version: `1 (Thursday, March 11th 2021 at 9:01 pm)
