...
param2_callName:(param2_type)param2_varName;
  @MiPadOS13_ObjectiveC classname : superclassname {
    // Start of script
    // Warning: MacOS and iOS/iPadOS programming differs. This script has a higher chance of not working due to non-existant mobile libraries
    // Connecting 2 iPadOS 13 applications together. Note that I have very little experience with Objective-C, so this script likely doesn't work correctly, and is currently just a demo script
    //Definitions
...
@end
/* File info
* File version: `1 (Thursday, March 11th 2021 at 8:44 pm)
