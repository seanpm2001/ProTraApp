...
param2_callName:(param2_type)param2_varName;
  @MiPhoneOS2_ObjectiveC classname : superclassname {
    // Start of script
    ...
    // Connecting iPhone OS 2 applications together. Note that I have very little experience with Objective-C, so this script likely doesn't work correctly, and is currently just a demo script
    //Definitions
...
@end
/* File info
* File version: `1 (Thursday, March 11th 2021 at 8:23 pm)
