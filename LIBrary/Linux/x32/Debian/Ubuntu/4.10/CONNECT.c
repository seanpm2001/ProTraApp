#include <stdio.h>
// Start of script
// Connecting 2 Ubuntu apps together (4.10)
// Definitions
union ubuntu(int(4.10)) // Trying to form a class here, so it can detect from different Ubuntu versions.
...
/* File info
* File version: `1 (Sunday, March 7th 2021 at 6:12 pm)
