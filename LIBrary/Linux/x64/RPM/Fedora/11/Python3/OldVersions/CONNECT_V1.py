  # Start of script
_WindowsMIMEidentifier_ = str("Fedora 11 (64 bit): Python 3")
# Connecting 2 Fedora 11 (x64) programs together. Due to technical limitations with my knowledge on Python, this is currently just a demo script and is not yet functional
# Definitions
...
# End of main method
""" File info
File version: `1 (Wednesday, March 10th 2021 at 9:31 pm)
