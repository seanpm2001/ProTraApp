#include <stdio.h>
// Start of script
// Connecting 2 Fedora 17 apps together (64 bit)
// Definitions
union fedora(int(17.86.64)) // Trying to form a class here, so it can detect from different Fedora versions.
...
/* File info
* File version: `1 (Wednesday, March 10th 2021 at 7:02 pm)
