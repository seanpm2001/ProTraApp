# Start of script
_Linux_Fedora_MIMEidentifier_ = str("Fedora 30 (64 bit): Python 3")
# Connecting 2 Fedora 30 (64 bit) programs together. Due to technical limitations with my knowledge on Python, this is currently just a demo script and is not yet functional
# Definitions
...
# End of main method
""" File info
File version: `1 (Wednesday, March 10th 2021 at 10:17 pm)
