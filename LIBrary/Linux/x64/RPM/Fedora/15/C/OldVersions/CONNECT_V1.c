...
// Definitions
union fedora(int(15.86.64)) // Trying to form a class here, so it can detect from different Fedora versions.
...
/* File info
* File version: `1 (Wednesday, March 10th 2021 at 7:00 pm)
