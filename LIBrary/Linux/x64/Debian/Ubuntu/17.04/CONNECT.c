#include <stdio.h>
// Start of script
// Connecting 2 Ubuntu apps together (17.04)
// Definitions
union ubuntu(int(17.04)) // Trying to form a class here, so it can detect from different Ubuntu versions.
...
/* File info
* File version: `1 (Sunday, March 7th 2021 at 5:31 pm)
